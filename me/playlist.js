...
Object.assign(MediaElementPlayer.prototype, {
	...
	buildplaylist (player, controls, layers, media) {
		...
		mejs.Utils.addClass(player.playlistLayer, `${player.options.classPrefix}playlist-hidden`);
		});
		...
		if (player.options.showPlaylist) {
			...
			player.playlistLayer.className = `${player.options.classPrefix}playlist-layer  ${player.options.classPrefix}layer ${(player.isVideo ? `${player.options.classPrefix}playlist-selector` : '')} ${player.options.classPrefix}playlist-selector`;
